...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // 6. Create variables that hold the otu_ids, otu_labels, and sample_values.
      var top10_otu_ids = result.otu_ids.slice(0, 10).map(numericIds => {
        return 'OTU ' + numericIds;
      }).reverse();
    
      var top10_sample_values = result.sample_values.slice(0, 10).reverse();
    ...
    // 9. Create the layout for the bar chart. 
      var barLayout = {
        title: {text: "Top 10 Bacteria Cultures Found", font: {size: 18}},
      };
    ...
    //var result = resultArray[0];
      ...
      var bubbleLayout = {
        ...
        title: {text: "Bacteria Cultures per sample", font: {size: 18}},
        showlegend: false,
      };
